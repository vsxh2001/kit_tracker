...
import { LayoutDashboard, Package, Users, FileText, LogOut, Box, UserCog, Menu, X, Cpu, BarChart3, ScrollText, Wrench, Clock, User, Tag, Sparkles, CalendarDays, Activity } from "lucide-react";
    ...
    <>
      ...
      {hasRole && (
        <NavLink
          ...
          className={({ isActive }) =>
            cn(
              "flex items-center gap-2.5 pl-8 pr-3 py-1.5 rounded-md text-sm transition-all",
              isActive
                ? "bg-indigo-600 text-white shadow-sm shadow-indigo-900/50"
