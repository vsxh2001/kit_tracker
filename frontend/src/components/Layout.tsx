...
import { LayoutDashboard, Package, Users, FileText, LogOut, Box, UserCog } from "lucide-react";
...
export function Layout() {
  ...
  return (
    <div className="flex h-screen bg-background">
      {/* Sidebar */}
      <aside className="w-56 flex flex-col bg-slate-900 shrink-0 border-r border-slate-800">
